...
###################################
import pandas as pd
df=pd.read_csv(r"C:\Users\shivam.mishra2\Downloads\Sildenafil.csv")
df.sample()
len(df)
from langchain_ollama import ChatOllama
...
prompt_message = HumanMessagePromptTemplate.from_template(
    template="Select the top 3 abstracts from the following summaries that best match the indication: Treatment of erectile dysfunction in adult males.\n\n{summaries}"
)
